...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/laotang013/Modulized.git"
  ...
  s.source       = { :git => "https://github.com/laotang013/Modulized.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Modulized/Modulized/**/*.{h,m}"
